...
export default function AddProblem() {
  ...
  const handleAdd = async () => {
    ...
    if (sample && notSample)
      dispatch(asyncProblemAdd({ detail: problemDetail, testcase }));
          ...
          <div className="flex items-start">
            ...
            <div className="flex-grow h-40 max-w-[880px]">
              <MDEditor
                ...
                onChange={(e) =>
                  setProblemDetail({ ...problemDetail, statement:e})
                }
                preview="edit"
              />
            </div>
          ...
          <div className="flex items-start">
            ...
            <div className="flex-grow h-40 max-w-[880px]">
              <MDEditor
                ...
                onChange={(e) =>
                  setProblemDetail({ ...problemDetail, input:e })
                }
                previewOptions={{
          ...
          <div className="flex items-start">
            ...
            <div className="flex-grow h-40  max-w-[880px]">
              <MDEditor
                ...
                onChange={(e) =>
                  setProblemDetail({ ...problemDetail, output:e })
                }
                previewOptions={{
                  rehypePlugins: [[rehypeSanitize]],
                }}
